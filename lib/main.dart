...
var cities = [new City('Minsk'), new City('Pinsk'), new City('Vitebsk'), new City('Brest'), new City('Homel'), new City('Grodno')];
                                  ...
                                  return Dismissible(
                                      ...
                                      child: Container(
                                        ...
                                        child: Material(
                                          ...
                                          child: ListTile(
                                            title: Center(child: Text('${cities[index].city}')),
                                      ...
                                      Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Image.network('${cities[index].list[0]!.icon}'),
                                            Text(
                                                    ...
                                                    child: Material(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: Column(
                                                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                          children: [
                                                            Text('${cities[index].list[ind].date!}', style: TextStyle(fontSize: 18, color: fontColor),),
                                                            Text('${cities[index].list[ind].temp!} \u00B0C', style: TextStyle(fontSize: 18, color: fontColor),),
                                                            Image.network('${cities[index].list[ind].icon!}')
                                                          ],
                                                        ),
                                                      ),
                                                    ),
                                                                ...
                                                                child: Material(
                                                                  ...
                                                                  child: Stack(
                                                                    children: [
                                                                      ...
                                                                      Center(
                                                                          child: Image(image: AssetImage('lib/assets/compass.png'), color: fontColor,)
                                                                      ),
                                                                      Center(
                                                                        child: new RotationTransition(
                                                                          turns: new AlwaysStoppedAnimation((cities[index].windDirection! + 180) / 360),
                                                                          child: new Icon(CupertinoIcons.arrow_up, size: 50, color: fontColor,),
                                                                        ),
                                                                      ),
                                                                    ],
                                                                  ),
                                                              ...
                                                              child: Material(
                                                                ...
                                                                child: Center(
                                                                  child: Column(
                                                                    children: [
                                                                      SizedBox(height: 25,),
                                                                      Icon(CupertinoIcons.drop_fill, size: 75, color: fontColor,),
                                                                      Text(
                                                            ...
                                                            Container(
                                                              ...
                                                              child: Material(
                                                                ...
                                                                child: Column(
                                                                  children: [
                                                                    SizedBox(height: 45,),
                                                                    Icon(CupertinoIcons.cloud_fill, color: fontColor, size: 50,),
                                                                    Text(
                                                                      '${cities[index].clouds!} %',
                                                                      style: TextStyle(
                                                                          color: fontColor,
                                                            ...
                                                            Container(
                                                              ...
                                                              child: Material(
                                                                ...
                                                                child: Center(
                                                                  child: Column(
                                                                    children: [
                                                                      Image.network('${cities[index].iconUri!}'),
                                                                      Text(
                                                              ...
                                                              child: Material(
                                                                ...
                                                                child: Column(
                                                                  children: [
                                                                    ...
                                                                    Icon(CupertinoIcons.person_2_alt, color: fontColor, size: 50,),
                                                                    Text(
                                                              ...
                                                              child: Material(
                                                                ...
                                                                child: Column(
                                                                  children: [
                                                                    ...
                                                                    Icon(CupertinoIcons.speedometer, color: fontColor, size: 65,),
                                                                    Text(
